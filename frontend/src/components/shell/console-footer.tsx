...
export function ConsoleFooter() {
  ...
  return (
    <footer
      data-testid="awsc-nav-footer"
      className="flex w-full flex-wrap items-center justify-between gap-y-2 px-4 py-2 text-xs"
      style={{
    ...
    >
      ...
      <span
        data-testid="awsc-footer-copyright"
      ...
      {/* Right section */}
      <ul className="flex flex-wrap items-center gap-x-5 gap-y-1 list-none m-0 p-0">
        <li>
